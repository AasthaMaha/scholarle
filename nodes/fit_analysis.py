...
FIT_ANALYSIS_INSTRUCTIONS = (
    ...
    "- Write every output field for a student-facing screen. Never mention agents, prompts, "
    "downstream code, formulas, weights, thresholds, score bands, hard gates, or internal field "
    "names. Say 'eligibility requirement' instead of 'hard requirement'.\n"
